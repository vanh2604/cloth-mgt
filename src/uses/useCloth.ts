...
const useCloth =  () => {
        ...
        const handleDelete = async (id : any) => {
            try {
                await axios.delete(`http://ec2-13-215-140-47.ap-southeast-1.compute.amazonaws.com:8080/api/clothes/delete/${id}`)
        ...
        const {data} = await axios.get("http://ec2-13-215-140-47.ap-southeast-1.compute.amazonaws.com:8080/api/style/getAll")
